...
//        return username.contains("a-z");
    ...
    private void performLogin(String username,String password) {
        ...
        retrofitService.UserInfo(username,password,new Callback<User>() {
            ...
            public void onSuccess(User response) {
                if (response != null) {
                    if(response.getId()!=null){
                        ...
                        editor.putInt("WalletMoney",response.getWalletMoney());
                        editor.apply();

                        Intent i = new Intent(LoginActivity.this,UserActivity.class);
                        i.putExtra("Id",response.getId());
                        i.putExtra("Name",response.getName());
                        i.putExtra("UserName",response.getUsername());
                        i.putExtra("WalletMoney",response.getWalletMoney());
                        startActivity(i);
                    }else{
                        showProgress(false);
